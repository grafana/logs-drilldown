...
1. On the Logs tab, you can:
   - Use the log controls (click the expand/collapse button on the right) to adjust sort order, filter by string or level, change display options, and more. For details, refer to [View logs](../view-logs/).
   ...
   - Use line wrapping controls to format JSON logs for easier reading.
