...
const JSONFilterNestedNodeInButton = memo(({ addFilter, keyPath, jsonKey, active }: Props) => {
  return (
    <IconButton
...
JSONFilterNestedNodeInButton.displayName = 'JSONFilterNestedNodeInButton';
export default JSONFilterNestedNodeInButton;
