  ...
  return (
    <span className={styles.wrapper}>
      ...
      <span className={styles.rightAlign}>
        <IconButton
          tooltip={t('logs-table-header.tooltip.show-menu', 'Show {{name}} menu', { name: props.field.name })}
          tooltipPlacement={'top'}
          ref={referenceElement}
          aria-label={t('logs-table-header.aria-label.show-menu', 'Show {{name}} menu', { name: props.field.name })}
          onClick={(e) => {
