/**
 * Plain-data fixtures for `{service_name="tempo-distributor"}`.
 *
 * Primary breakdown service for `tests/exploreServicesBreakDown.spec.ts`. See
 * `../service_name-tempo-ingester/index.ts` for the canonical reference.
 */
