/**
 * Plain-data fixtures for `{service_name="nginx-json"}`.
 *
 * See `../service_name-tempo-ingester/index.ts` for the canonical reference —
 * this folder mirrors the same shape but with nginx-json captures.
 */
