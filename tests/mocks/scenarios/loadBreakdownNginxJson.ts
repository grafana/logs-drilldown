...
/**
 * Scenario: user has drilled into `{service_name="nginx-json"}`. Layers
 * nginx-json data over the default `tempo-ingester` per-service routes.
 */
export async function loadBreakdownNginxJson(page: Page) {
