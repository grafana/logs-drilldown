...
/**
 * Scenario: user has drilled into `{service_name="tempo-distributor"}`. Layers
 * tempo-distributor data over the default `tempo-ingester` per-service routes.
 */
export async function loadBreakdownTempoDistributor(page: Page) {
